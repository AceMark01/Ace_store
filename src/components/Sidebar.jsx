                ...
                <div className="flex flex-col h-full">
                    <div className="h-24 flex items-center justify-between px-6 border-b border-slate-100">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-xl bg-red-600 p-1.5 shadow-lg shadow-red-500/20 ring-1 ring-white/20">
                                <img src={logo} alt="Ace Store Logo" className="w-full h-full object-contain brightness-0 invert" />
                            </div>
                            <div>
                                <h1 className="text-xl font-black tracking-tight text-slate-800 leading-none">Ace Store</h1>
                                <p className="text-[10px] font-bold text-red-600 tracking-widest mt-1 uppercase">
